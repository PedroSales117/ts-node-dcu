...
/**
 * FileRateLimitAdapter provides rate limiting functionality using a file-based storage.
 */
export class FileRateLimitAdapter implements IRateLimitStorage {
    ...
    /**
     * Constructs a new FileRateLimitAdapter.
