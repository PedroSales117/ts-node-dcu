...
import { RateLimitAdapter } from '../configurations/adapters/rate-limit.adapter';
...
export class RateLimitMiddleware {
    private storage: RateLimitAdapter;
    ...
    constructor(config: RateLimitConfig) {
        ...
        this.storage = new RateLimitAdapter(this.defaultConfig);
